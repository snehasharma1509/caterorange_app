...
// //         // var categoryId= data.details[0].category_id;
// //         // console.log('id:', data.details.length);
// //       try{
   
// //       console.log('outside loop', orderData);
// //       for(let i=0; i<orderData.length; i++){
// //         categoryId= data.details[i].category_id;
// //        console.log('inside loop id', categoryId)
// //         var res= await axios.post('http://localhost:7000/customer/getcategorynameByid',{
// //            categoryId
// //         });
// //         category_name= res.data.categoryname;
// //        if(res.data.success){
// //           console.log('category name fetched',category_name)
// //        }
// //        else{
// //          console.log('category name not fetched')
// //        }
// //       }
...
// //                   <td className="p-2 sm:p-3 lg:p-4 whitespace-nowrap">{category_name || 'N/A'}</td>
...
//                 <tr key={i} className="border-t text-xs sm:text-sm hover:bg-gray-50">
//                   <td className="p-2 sm:p-3 lg:p-4 whitespace-nowrap">{detail.category_id}</td>
//                   <td className="p-2 sm:p-3 lg:p-4 whitespace-nowrap">{renderProgressIcons(detail.delivery_status)}</td>
//                   <td className="p-2 sm:p-3 lg:p-4 whitespace-nowrap">{detail.processing_date}</td>
//                   <td className="p-2 sm:p-3 lg:p-4 whitespace-nowrap">{detail.quantity}</td>
//                   <td className="p-2 sm:p-3 lg:p-4 whitespace-nowrap">{detail.active_quantity}</td>
                ...
                order_details: await Promise.all(
                  order.order_details.map(async (detail) => {
                    try {
                      ...
                      return {
                        ...detail,
                        category_name: categoryResponse.data.categoryname || 'N/A'
                      };
                    } catch (error) {
                      console.error('Error fetching category name:', error);
                      return { ...detail, category_name: 'N/A' };
                    }
                  })
                )
              };
              return orderWithCategoryNames;
            })
          );
              ...
              {order.order_details.map((detail, i) => (
                <tr key={i} className="border-t text-xs sm:text-sm hover:bg-gray-50">
                  <td className="p-2 sm:p-3 lg:p-4 whitespace-nowrap">
                    {typeof detail.category_name === 'string' ? detail.category_name : 'N/A'}
                  </td>
                  <td className="p-2 sm:p-3 lg:p-4 whitespace-nowrap">{renderProgressIcons(detail.delivery_status)}</td>
                  <td className="p-2 sm:p-3 lg:p-4 whitespace-nowrap">{detail.processing_date}</td>
                  <td className="p-2 sm:p-3 lg:p-4 whitespace-nowrap">{detail.quantity}</td>
